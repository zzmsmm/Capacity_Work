...
def set_up_optim_sched(args, net):
    ...
    if args.sched == 'MultiStepLR':
        # scheduler = MultiStepLR(optimizer, milestones=[20, 35, 45, 80, 100, 120, 140, 160, 180], gamma=args.lradj)
        # scheduler = MultiStepLR(optimizer, milestones=[15, 35, 45, 80, 100, 120, 140, 160, 180], gamma=args.lradj) # mnist
        scheduler = MultiStepLR(optimizer, milestones=[60, 80, 100, 120, 140, 160, 180], gamma=args.lradj) # cifar10 better
